...
from att_dataset_6 import AttDataset
from attribute_predictor_6 import AttributePredictor
...
class RedirectPrintToFile:
    ...
    def __init__(self, filepath):
        """
        Initializes the context manager with a file path.
        
        Parameters:
        - filepath: str, the path to the file where stdout will be redirected.
        """
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        """Restores stdout and closes the file."""
...
def main(args):
    ...
    with RedirectPrintToFile(model_path):
        print(model)
